...
class PurchaseCreateView(View):                                                 
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            msg = f"New {stock} have been registered  {billitem.quantity} pcs. Your current {stock} stock is {stock.quantity} pcs"
...
class SaleCreateView(View):                                                      
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            msg = f"New {stock} have been Sold  {billitem.quantity} pcs. Your current {stock} stock is {stock.quantity} pcs  "
            send_msg_on_telegram(msg)
